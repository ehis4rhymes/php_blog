...
<?php include '../liberaries/Database.php'; ?>
  ...
  <body>
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          ...
          <a class="blog-nav-item pull-right" href="http://localhost/phploversblog">Visit Blog|Home</a>
        </nav>
      </div>
    </div>s
    ...
    <div class="container">
      <div class="blog-header">
        ...
        <p class="lead blog-description">Add PHP News, Tutorials, Videos & More.</p>
      </div>
